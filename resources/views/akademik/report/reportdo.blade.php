...
<!-- Page content -->
<section class="page-content page-content__akademik container-fluid" id="akademik_reportdo">
  <div class="row">
    <div class="col-xl-12">
          ...
          <table class="table align-items-center table-borderless table-flush table-hover">
            <thead class="table-header">
              <tr>
                ...
                <th scope="col" class="border-0 text-center">Tanggal drop out</th>
                <th scope="col" class="border-0">Alasan Drop out</th>
