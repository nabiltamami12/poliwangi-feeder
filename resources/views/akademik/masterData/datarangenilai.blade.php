...
<!-- Page content -->
<section class="page-content page-content__akademik container-fluid" id="akademik_datarangenilai">
  <div class="row">
    <div class="col-xl-12">
    ...
    "aoColumnDefs": [
      {
        ...
        "mRender": function(data, type, full) {
          ...
          var btn_delete = `<span class="iconify delete-icon" data-icon="bx:bx-trash" data-inline="true" onclick='delete_btn(${id},"rangenilai","range nilai","${text_hapus}")'></span>`; 
