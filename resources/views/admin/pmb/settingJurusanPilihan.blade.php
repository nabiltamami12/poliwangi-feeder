        ...
        <div class="card-header p-0">
          <div class="row align-items-center">
            <div class="col-12 col-md-6">
              <h2 class="mb-0 text-center text-md-left">Jurusan Pilihan</h2>
            </div>
            <div class="col-12 col-md-6 text-center text-md-right mt-3 mt-md-0">
              ...
              <a class="btn btn-info_transparent2 ml-md-2 text-primary" href="/admin/settingpmb/editjurusanpilihan"
                role="button">
