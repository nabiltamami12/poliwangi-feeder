        ...
        <div class="card-header p-0 m-0 border-0 ">
          <div class="row align-items-center">
            <div class="col-12 col-md-6">
              <h2 class="mb-0 text-center text-md-left">Jurusan Asal Pendaftar</h2>
            </div>
            <div class="col-12 col-md-6 text-center text-md-right mt-3 mt-md-0">
              ...
              <a class="btn btn-info_transparent ml-0 ml-md-2 text-primary" href="/admin/settingpmb/editjurusanasal"
                role="button">
          ...
          <table class="table align-items-center table-flush table-borderless table-hover">
            <thead class="table-header">
              <tr>
                ...
                <th scope="col" style="width: 75%">Nama</th>
            ...
            <tbody class="table-body">
              <tr>
                ...
                <td class="font-weight-bold text-capitalize">Ilmu pengetahuan alam</td>
              ...
              <tr>
                ...
                <td class="font-weight-bold text-capitalize">Ilmu pengetahuan sosial</td>
                <td class="text-center">
                  <i class="iconify-inline delete-icon text-primary" data-icon="bx:bx-trash"></span>
                </td>
              </tr>
