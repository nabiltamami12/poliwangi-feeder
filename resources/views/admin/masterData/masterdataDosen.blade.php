          ...
          <table class="table align-items-center table-flush table-borderless table-hover">
            <thead class="table-header">
              <tr>
                ...
                <th scope="col" class="text-center">no induk dosen</th>
                <th scope="col" class="pl-2">Nama</th>
            ...
            <tbody class="table-body">
              <tr>
                ...
                <td class="text-center">
                  <a href="/admin/masterdata/datadosen/updatedata"><i class="iconify edit-icon mr-2"
