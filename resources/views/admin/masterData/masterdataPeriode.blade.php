          ...
          <table class="table align-items-center table-flush table-borderless table-hover">
            ...
            <tbody class="table-body">
              <tr>
                ...
                <td class="font-weight-bold">2021/2022</td>
                <td class="font-weight-bold text-uppercase">ganjil</td>
                ...
                <td class="text-center">
                  <a href="#"><i class="iconify edit-icon mr-2" data-icon="bx:bx-edit-alt"></i></a>
                  <span data-toggle="modal" data-target="#" class="iconify delete-icon" data-icon="bx:bx-trash"></span>
                </td>
              </tr>

              <tr>
                <td class="text-center px-2">2</td>
                <td class="font-weight-bold">2020/2021</td>
                <td class="font-weight-bold text-uppercase">genap</td>
                <td class="text-center">
                  <button class="btn btn-warning">
                    <i class="iconify-inline mr-1" data-icon="akar-icons:circle-check-fill"></i>
                    Aktifkan
              ...
              <tr>
                ...
                <td class="font-weight-bold">2029/2020</td>
                <td class="font-weight-bold text-uppercase">ganjil</td>
                <td class="text-center">
                  <button class="btn btn-warning">
                    <i class="iconify-inline mr-1" data-icon="akar-icons:circle-check-fill"></i>
              ...
              <tr>
                ...
                <td class="text-center text-success">
                  <span>Aktif</span>
                  <i class="iconify-inline ml-1" data-icon="akar-icons:circle-check-fill"></i>
                </td>
                <td class="text-center">
                  <a href="#"><i class="iconify edit-icon mr-2" data-icon="bx:bx-edit-alt"></i></a>
                  <span data-toggle="modal" data-target="#" class="iconify delete-icon" data-icon="bx:bx-trash"></span>
