...
<!-- Page content -->
<section class="page-content page-content__prodi container-fluid" id="prodi_masterdataruangan">
  <!-- Modal -->
  <div class="modal fade" id="deleteRuanganModal" tabindex="-1" aria-labelledby="deleteRuanganModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content p-0 padding--medium">
        ...
        <div class="modal-body">
          <p class="text-center">Apakah anda yakin mau menghapus data ruangan :</p>
          <h2 class="text-center">Ruang 1</h2>
          <h2 class="text-center">kode : RKB001</h2>
        </div>
        ...
        <div class="card-header p-0 m-0 border-0 rounded-0">
          <div class="row align-items-center">
            ...
            <div class="col-12 col-md-6 text-center text-md-right mt-3 mt-md-0">
              <a class="btn btn--blue" href="/prodi/masterdata/dataruangan/tambahdata" role="button">
          ...
          <table class="table align-items-center table-flush table-borderless table-hover">
            <thead class="table-header">
              <tr>
                ...
                <th scope="col" class="border-0" style="width: 40%">Ruang</th>
            ...
            <tbody class="table-body">
              <tr>
                ...
                <td class="text-center">
                  <a href="/prodi/masterdata/dataruangan/updatedata"><span class="iconify edit-icon"
