...
<!-- Page content -->
<section class="page-content page-content__prodi container-fluid" id="prodi_masterdatadosen">
  <!-- Modal -->
  <div class="modal fade" id="deleteDosenModal" tabindex="-1" aria-labelledby="deleteDosenModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content p-0 padding--medium">
        ...
        <div class="modal-body">
          <p class="text-center">Apakah anda yakin mau menghapus data dosen :</p>
          <h2 class="text-center">Prof. Melani Yosephin, Ph.D</h2>
          <h2 class="text-center">NIDN : 325824932</h2>
        </div>
          ...
          <table class="table align-items-center table-flush table-borderless table-hover">
            <thead class="table-header">
              <tr>
                ...
                <th scope="col" class="border-0 text-center">no induk dosen</th>
                <th scope="col" class="border-0 pl-2">Nama</th>
