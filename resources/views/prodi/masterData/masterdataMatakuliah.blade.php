...
<!-- Page content -->
<section class="page-content page-content__prodi container-fluid" id="prodi_masterdatamatakuliah">
  <!-- Modal -->
          ...
          <table class="table align-items-center table-flush table-borderless table-hover">
            <thead class="table-header">
              <tr>
                ...
                <th scope="col" class="border-0">Kurikulum</th>
                <th scope="col" class="border-0 text-center">smstr</th>
                <th scope="col" class="border-0 text-center">sks-t</th>
                <th scope="col" class="border-0 text-center">sks-p</th>
                <th scope="col" class="border-0 text-center">sks-l</th>
