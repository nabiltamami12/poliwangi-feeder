...
<!-- Page content -->
<section class="page-content page-content__prodi container-fluid" id="prodi_masterdatafakultas">
  <!-- Modal -->
  <div class="modal fade" id="deleteFakultasModal" tabindex="-1" aria-labelledby="deleteFakultasModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content p-0 padding--medium">
        ...
        <div class="modal-body">
          <p class="text-center">Apakah anda yakin mau menghapus data fakultas :</p>
          <h2 class="text-center">Fakultas Kedokteran Gigi</h2>
        </div>
      ...
      <div class="card shadow padding--small">
        ...
        <div class="card-header p-0 m-0 border-0 
          ...
          <div class="col-12 col-md-6">
            <h2 class="mb-0 text-center text-md-left">Data Fakultas</h2>
          </div>
          <div class="col-12 col-md-6 text-center text-md-right mt-3 mt-md-0">
            <a class="btn btn-primary" href="/prodi/masterdata/datafakultas/tambahdata" role="button">
        ...
        <table class="table align-items-center table-flush table-borderless table-hover">
          <thead class="table-header">
            <tr>
              ...
              <th scope="col" class="border-0" style="width: 80%">Nama fakultas</th>
