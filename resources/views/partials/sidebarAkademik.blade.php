      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            ...
            <ul class="nav-item-dropdown-content">
              <li class="nav-item">
                <a class="nav-link {{($title === "dosen-penilaian") ? 'aktif' : ''}}"
                  href="{{url('akademik/kuliah/penilaian')}}">
                  <span class="mini_icon">PE</span>
                  <span class="nav-link-text">Penilaian</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{($title === "rekap-nilai") ? 'aktif' : ''}}"
                  href="{{url('akademik/kuliah/rekap-nilai')}}">
                  <span class="mini_icon">RN</span>
                  <span class="nav-link-text">Rekap Nilai</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{($title === "absensi-mahasiswa") ? 'aktif' : ''}}"
                  href="{{url('akademik/kuliah/absensi/dashboard-mahasiswa')}}">
                  <span class="mini_icon">AM</span>
                  <span class="nav-link-text">Absensi Mahasiswa (Dashboard)</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{($title === "rekap-absensi-mahasiswa") ? 'aktif' : ''}}"
                  href="{{url('akademik/kuliah/absensi/rekap-mahasiswa')}}">
                  <span class="mini_icon">RA</span>
                  <span class="nav-link-text">Rekap Absensi Mahasiswa</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{($title === "absensi-dosen") ? 'aktif' : ''}}"
                  href="{{url('akademik/kuliah/absensi/kelas-dosen')}}">
                  <span class="mini_icon">AD</span>
                  <span class="nav-link-text">Absensi Dosen</span>
                </a>
              </li>
            </ul>
          </li>
