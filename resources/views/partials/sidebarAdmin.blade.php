        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            ...
            <ul class="nav-item-dropdown-content">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ url('/admin/kepegawaian/data-pangkat')}}">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ url('/admin/kepegawaian/data-pegawai')}}">
          ...
          <li class="nav-item">
            ...
            <ul class="nav-item-dropdown-content">
              ...
              <li class="nav-item">
                <a class="nav-link {{($title === "rekap-absensi-pegawai") ? 'aktif' : ''}}" href="{{url('admin/kuliah/absensi/pegawai')}}">
                  <span class="mini_icon">RP</span>
                  <span class="nav-link-text ml-0">Rekap Presensi Pegawai</span>
                </a>
              </li>
              <li class="nav-item">
